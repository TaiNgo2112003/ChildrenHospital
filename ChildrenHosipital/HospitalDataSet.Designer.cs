...
namespace ChildrenHosipital {
    ...
    public partial class HospitalDataSet : global::System.Data.DataSet {
        ...
        public partial class DoctorsDataTable : global::System.Data.TypedTableBase<DoctorsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public DoctorsRow AddDoctorsRow(string FullName, int DepartmentID, string PhoneNumber, string Email, string Image) {
        ...
        public partial class DoctorsRow : global::System.Data.DataRow {
            ...
            public string Image {
                get {
                    try {
                        return ((string)(this[this.tableDoctors.ImageColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace ChildrenHosipital.HospitalDataSetTableAdapters {
    ...
    public partial class DoctorsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Doctors] ([FullName], [DepartmentID], [PhoneNumber], [Email], [Image]) VALUES (@FullName, @DepartmentID, @PhoneNumber, @Email, @Image);
SELECT DoctorID, FullName, DepartmentID, PhoneNumber, Email, Image FROM Doctors WHERE (DoctorID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Doctors] SET [FullName] = @FullName, [DepartmentID] = @DepartmentID, [PhoneNumber] = @PhoneNumber, [Email] = @Email, [Image] = @Image WHERE (([DoctorID] = @Original_DoctorID) AND ([FullName] = @Original_FullName) AND ((@IsNull_DepartmentID = 1 AND [DepartmentID] IS NULL) OR ([DepartmentID] = @Original_DepartmentID)) AND ((@IsNull_PhoneNumber = 1 AND [PhoneNumber] IS NULL) OR ([PhoneNumber] = @Original_PhoneNumber)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Image = 1 AND [Image] IS NULL) OR ([Image] = @Original_Image)));
SELECT DoctorID, FullName, DepartmentID, PhoneNumber, Email, Image FROM Doctors WHERE (DoctorID = @DoctorID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT DoctorID, FullName, DepartmentID, PhoneNumber, Email, Image FROM dbo.Docto" +
                "rs";
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(HospitalDataSet.DoctorsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_DoctorID, string Original_FullName, global::System.Nullable<int> Original_DepartmentID, string Original_PhoneNumber, string Original_Email, string Original_Image) {
        ...
        public virtual int Insert(string FullName, global::System.Nullable<int> DepartmentID, string PhoneNumber, string Email, string Image) {
            if ((FullName == null)) {
        ...
        public virtual int Update(string FullName, global::System.Nullable<int> DepartmentID, string PhoneNumber, string Email, string Image, int Original_DoctorID, string Original_FullName, global::System.Nullable<int> Original_DepartmentID, string Original_PhoneNumber, string Original_Email, string Original_Image, int DoctorID) {
            if ((FullName == null)) {
                throw new global::System.ArgumentNullException("FullName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FullName, global::System.Nullable<int> DepartmentID, string PhoneNumber, string Email, string Image, int Original_DoctorID, string Original_FullName, global::System.Nullable<int> Original_DepartmentID, string Original_PhoneNumber, string Original_Email, string Original_Image) {
            return this.Update(FullName, DepartmentID, PhoneNumber, Email, Image, Original_DoctorID, Original_FullName, Original_DepartmentID, Original_PhoneNumber, Original_Email, Original_Image, Original_DoctorID);
        }
    }
