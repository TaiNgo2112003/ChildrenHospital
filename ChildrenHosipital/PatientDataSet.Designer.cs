...
namespace ChildrenHosipital {
    ...
    public partial class PatientDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsersRow AddUsersRow(string Username, string Password, string FullName, string Email, string PhoneNumber, string Role) {
...
namespace ChildrenHosipital.PatientDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Users] ([Username], [Password], [FullName], [Email], [PhoneNumber], [Role]) VALUES (@Username, @Password, @FullName, @Email, @PhoneNumber, @Role);
SELECT UserID, Username, Password, FullName, Email, PhoneNumber, Role FROM Users WHERE (UserID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [Username] = @Username, [Password] = @Password, [FullName] = @FullName, [Email] = @Email, [PhoneNumber] = @PhoneNumber, [Role] = @Role WHERE (([UserID] = @Original_UserID) AND ([Username] = @Original_Username) AND ([Password] = @Original_Password) AND ([FullName] = @Original_FullName) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_PhoneNumber = 1 AND [PhoneNumber] IS NULL) OR ([PhoneNumber] = @Original_PhoneNumber)) AND ([Role] = @Original_Role));
SELECT UserID, Username, Password, FullName, Email, PhoneNumber, Role FROM Users WHERE (UserID = @UserID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserID, Username, Password, FullName, Email, PhoneNumber, Role FROM dbo.Us" +
                "ers";
        ...
        public virtual int Fill(PatientDataSet.UsersDataTable dataTable) {
        ...
        public virtual PatientDataSet.UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PatientDataSet.UsersDataTable dataTable = new PatientDataSet.UsersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PatientDataSet.UsersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_UserID, string Original_Username, string Original_Password, string Original_FullName, string Original_Email, string Original_PhoneNumber, string Original_Role) {
        ...
        public virtual int Insert(string Username, string Password, string FullName, string Email, string PhoneNumber, string Role) {
            if ((Username == null)) {
        ...
        public virtual int Update(string Username, string Password, string FullName, string Email, string PhoneNumber, string Role, int Original_UserID, string Original_Username, string Original_Password, string Original_FullName, string Original_Email, string Original_PhoneNumber, string Original_Role, int UserID) {
            if ((Username == null)) {
                throw new global::System.ArgumentNullException("Username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Username, string Password, string FullName, string Email, string PhoneNumber, string Role, int Original_UserID, string Original_Username, string Original_Password, string Original_FullName, string Original_Email, string Original_PhoneNumber, string Original_Role) {
            return this.Update(Username, Password, FullName, Email, PhoneNumber, Role, Original_UserID, Original_Username, Original_Password, Original_FullName, Original_Email, Original_PhoneNumber, Original_Role, Original_UserID);
        }
    }
